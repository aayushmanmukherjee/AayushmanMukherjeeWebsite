...
const About = () => {
  return (
    ...
    whileInView={{ opacity: 1, scale: 1 }}
      ...
      viewport={{ amount: 0.1}} 
    >
    <div className="bg-black w-full h-[100vh] flex pt-10 max-md:pt-5 max-md:flex-col max-md:gap-5">
      <div className="w-[40%] ml-5 max-md:w-full max-md:text-center">
        <h2 className="big text-5xl max-lg:text-3xl max-md:text-2xl text-white">ABOUT ME</h2>
      </div>
      <div className="w-[60%] max-md:w-full mr-5 max-md:mr-0 flex flex-col max-md:items-center">
        ...
        <p className="poppins text-xl max-md:text-sm max-md:text-center mt-10 max-md:mt-5 text-white">
