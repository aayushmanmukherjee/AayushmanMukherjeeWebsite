...
const Introduction = () => {
  return (
    ...
    whileInView={{ opacity: 1, scale: 1 }}
     ...
     viewport={{ amount: 0.1}}
    >
    <div className='flex max-md:flex-col max-md:gap-5 w-full pt-10 max-md:pt-5 h-[100vh]'>
      <div className='w-[60%] max-md:w-full flex flex-col gap-2 max-md:items-center max-md:justify-center ml-5'>
      ...
      <div className='flex gap-5 ml-10 max-md:ml-0'>
      ...
      <p className='cursive ml-10 max-md:ml-0 mt-20 max-md:mt-10 text-5xl max-lg:text-xl max-md:text-sm max-md:text-center font-bold italic'>"In case I don't see ya, good afternoon, good evening, and good night!"</p>
      </div>
